          ...
          await knex.schema
            ...
            .testSql((tester) => {
              ...
              tester(
                ['pg', 'cockroachdb'],
                [
                  'create table "test_table_three" ("main" integer not null, "paragraph" text default \'Lorem ipsum Qui quis qui in.\', "metadata" json default \'{"a":10}\', "details" jsonb default \'{"b":{"d":20}}\', primary key ("main"))',
                ]
              );
              tester('pg-redshift', [
